 ...
 * Date: 13-7-30
 */
@Table("player_all_in_one")
public class PlayerAllInOne
{
    public long size()
    {
        long ret = 0;
        ret += playerBagStore.toBlob().toByteArray().length;
        ret += playerEventSysStore.toBlob().toByteArray().length;
        ret += playerFriendStore.toBlob().toByteArray().length;
        ret += playerGuajiStore.toBlob().toByteArray().length;
        ret += playerMsgStore.toBlob().toByteArray().length;
        ret += playerRechargeStore.toBlob().toByteArray().length;
        ret += playerTaskLevelBattleAgainStore.toBlob().toByteArray().length;
        ret += playerWuxingCardStore.toBlob().toByteArray().length;
        ret += playerWuxingRaffleInfoStore.toBlob().toByteArray().length;
        ret += 512;
        return ret;
    }
    @Column(name = "bag_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerBagStoreBlob.class)
    private PlayerBagStore                  playerBagStore                  = new PlayerBagStore();
    @Column(name = "event_sys_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerEventSysStoreBlob.class)
    private PlayerEventSysStore             playerEventSysStore             = new PlayerEventSysStore();
    @Column(name = "friend_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerFriendStoreBlob.class)
    private PlayerFriendStore               playerFriendStore               = new PlayerFriendStore();
    @Column(name = "guaji_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerGuajiStoreBlob.class)
    private PlayerGuajiStore                playerGuajiStore                = new PlayerGuajiStore();
    @Column(name = "msg_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerMsgStoreBlob.class)
    private PlayerMsgStore                  playerMsgStore                  = new PlayerMsgStore();
    @Column(name = "recharge_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerRechargeStoreBlob.class)
    private PlayerRechargeStore             playerRechargeStore             = new PlayerRechargeStore();
    @Column(name = "task_level_battle_again_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerTaskLevelBattleAgainStoreBlob.class)
    private PlayerTaskLevelBattleAgainStore playerTaskLevelBattleAgainStore = new PlayerTaskLevelBattleAgainStore();
    @Column(name = "wuxing_card_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerWuxingCardStoreBlob.class)
    private PlayerWuxingCardStore           playerWuxingCardStore           = new PlayerWuxingCardStore();
    @Column(name = "wuxing_raffle_info_blob", type = Column.ColumnType.BLOB, blobClass = Entity.PlayerWuxingRaffleInfoStoreBlob.class)
    private PlayerWuxingRaffleInfoStore     playerWuxingRaffleInfoStore     = new PlayerWuxingRaffleInfoStore();
    /**
    ...
    public PlayerBagStore getPlayerBagStore()
    {
        return playerBagStore;
    }
    public void setPlayerBagStore(PlayerBagStore playerBagStore)
    {
        this.playerBagStore = playerBagStore;
    }
    public PlayerEventSysStore getPlayerEventSysStore()
    {
        return playerEventSysStore;
    }
    public void setPlayerEventSysStore(PlayerEventSysStore playerEventSysStore)
    {
        this.playerEventSysStore = playerEventSysStore;
    }
    public PlayerFriendStore getPlayerFriendStore()
    {
        return playerFriendStore;
    }
    public void setPlayerFriendStore(PlayerFriendStore playerFriendStore)
    {
        this.playerFriendStore = playerFriendStore;
    }
    public PlayerGuajiStore getPlayerGuajiStore()
    {
        return playerGuajiStore;
    }
    public void setPlayerGuajiStore(PlayerGuajiStore playerGuajiStore)
    {
        this.playerGuajiStore = playerGuajiStore;
    }
    public PlayerMsgStore getPlayerMsgStore()
    {
        return playerMsgStore;
    }
    public void setPlayerMsgStore(PlayerMsgStore playerMsgStore)
    {
        this.playerMsgStore = playerMsgStore;
    }
    public PlayerRechargeStore getPlayerRechargeStore()
    {
        return playerRechargeStore;
    }
    public void setPlayerRechargeStore(PlayerRechargeStore playerRechargeStore)
    {
        this.playerRechargeStore = playerRechargeStore;
    }
    public PlayerTaskLevelBattleAgainStore getPlayerTaskLevelBattleAgainStore()
    {
        return playerTaskLevelBattleAgainStore;
    }
    public void setPlayerTaskLevelBattleAgainStore(PlayerTaskLevelBattleAgainStore playerTaskLevelBattleAgainStore)
    {
        this.playerTaskLevelBattleAgainStore = playerTaskLevelBattleAgainStore;
    }
    public PlayerWuxingCardStore getPlayerWuxingCardStore()
    {
        return playerWuxingCardStore;
    }
    public void setPlayerWuxingCardStore(PlayerWuxingCardStore playerWuxingCardStore)
    {
        this.playerWuxingCardStore = playerWuxingCardStore;
    }
    public PlayerWuxingRaffleInfoStore getPlayerWuxingRaffleInfoStore()
    {
        return playerWuxingRaffleInfoStore;
    }
    public void setPlayerWuxingRaffleInfoStore(PlayerWuxingRaffleInfoStore playerWuxingRaffleInfoStore)
    {
        this.playerWuxingRaffleInfoStore = playerWuxingRaffleInfoStore;
    }
}
